...
import { cyan, teal, grey, deepPurple } from '@material-ui/core/colors';
...
export const RecordColor = {
  ...
  Cyan: cyan[RECORD_SHADE],
  Teal: teal[RECORD_SHADE],
  Grey: grey[RECORD_SHADE],
  DeepPurple: deepPurple[RECORD_SHADE],
  Default: "",
};
...
export const DarkRecordColor = {
  ...
  Cyan: cyan[DARK_RECORD_SHADE],
  Teal: teal[DARK_RECORD_SHADE],
  Grey: grey[DARK_RECORD_SHADE],
  DeepPurple: deepPurple[DARK_RECORD_SHADE],
  Default: "",
};
...
export const ColumnColor = {
  ...
  Cyan: cyan[COLUMN_SHADE],
  Teal: teal[COLUMN_SHADE],
  Grey: grey[COLUMN_SHADE],
  DeepPurple: deepPurple[COLUMN_SHADE],
  Default: "",
};
...
export const DarkColumnColor = {
  ...
  Cyan: cyan[DARK_COLUMN_SHADE],
  Teal: teal[DARK_COLUMN_SHADE],
  Grey: grey[DARK_COLUMN_SHADE],
  DeepPurple: deepPurple[DARK_COLUMN_SHADE],
  Default: "",
};
