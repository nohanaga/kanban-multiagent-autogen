...
export const ColumnHeader: React.FC<ColumnHeaderProps> = (props) => {
  ...
  const isActive =
    selectedSpeaker &&
    title &&
    selectedSpeaker.toLowerCase() === title.toLowerCase();

  // データフロー
  //   ChatBox.tsx
  //   └── onSelectedSpeakerChange(selected_speaker)
  //         ↓
  // KanbanBoardContainer (index.tsx)
  //         ↓ selectedSpeaker state更新
  // KanbanBoard (KanbanBoard.tsx)
  //         ↓ selectedSpeaker prop渡し
  // Board (Board.tsx)
  //         ↓ selectedSpeaker prop渡し
...
type ColumnProps = {
  ...
  selectedSpeaker?: string; // 追加: 現在の選択済み speaker 名
};
  ...
  return (
    ...
    >
      <ColumnHeaderComponent
        ...
        selectedSpeaker={selectedSpeaker}  // 追加: ここで渡す
      />
